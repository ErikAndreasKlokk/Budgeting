...
<form action="?/login" method="post" class="max-w-sm mx-auto" use:enhance>
	...
	<button type="submit" formaction="?/register" class="text-white bg-neutral-700 hover:bg-neutral-800 focus:ring-4 focus:outline-none focus:ring-neutral-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-neutral-600 dark:hover:bg-neutral-700 dark:focus:ring-neutral-800 ml-3">Register</button>
  </form>
